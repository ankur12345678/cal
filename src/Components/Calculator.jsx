...
import ConfettiExplosion from "react-confetti-explosion"; // for explosion of confetti
function Calculator() {
  ...
  const [prevCal, setPrevCal] = useState({}); // store all expression that are executed
  ...
  function handleSubmit() {
    ...
    setPrevCal((prev) => ({ ...prev, expression: eval(expression) }));
  ...
  return (
    <>
      ...
      <div>
        <input type="text" value={displayexp} />
      </div>
      <div>
        <table>
          <tr>
